...
#define AKM8789_TIMER_DEBOUNCE  50
#define AKM8789_TIMER_DOUBLE_DEBOUNCE  (2*AKM8789_TIMER_DEBOUNCE)
#define AKM8789_WAKEUP_TIME  (AKM8789_TIMER_DOUBLE_DEBOUNCE+20)
