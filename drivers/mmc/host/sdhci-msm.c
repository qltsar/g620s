...
#endif
#define EMMC_NO 1
static int huawei_hs200_close (void)
{
	int ret = 0;
	...
	np = of_find_compatible_node(NULL,NULL,"huawei-not-support-hs200");
	if(!np)
	{
...
#else
    /*for G620 G621 C8817D C8817E , close hs200 mode, because sandisk cannot support this feature*/
    if((EMMC_NO == of_alias_get_id(dev->of_node, "sdhc")) && huawei_hs200_close())
    {
        struct device_node *hs200_np = of_find_compatible_node(NULL,NULL,"huawei,huawei-hs200-close");
		if(NULL != hs200_np)
		{
